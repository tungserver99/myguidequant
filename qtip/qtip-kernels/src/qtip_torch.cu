...
__host__ extern void decompress_matvec_16_9_2_1_5120_1_5120(
    ...
    decompress_matvec<16U, 9U, 2U, 1U, 5120, 1U, 5120U>(out, compressed, x, codebook);
}
...
__host__ extern void decompress_matvec_16_9_3_1_5120_1_5120(
    ...
    decompress_matvec<16U, 9U, 3U, 1U, 5120, 1U, 5120U>(out, compressed, x, codebook);
}
...
__host__ extern void decompress_matvec_16_9_4_1_5120_1_5120(
    ...
    decompress_matvec<16U, 9U, 4U, 1U, 5120, 1U, 5120U>(out, compressed, x, codebook);
}


__host__ extern void decompress_matvec_16_9_2_1_5120_1_13824(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 2U, 1U, 5120, 1U, 13824U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_3_1_5120_1_13824(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 3U, 1U, 5120, 1U, 13824U>(out, compressed, x, codebook);
}
...
__host__ extern void decompress_matvec_16_9_4_1_5120_1_13824(
    ...
    decompress_matvec<16U, 9U, 4U, 1U, 5120, 1U, 13824U>(out, compressed, x, codebook);
}


__host__ extern void decompress_matvec_16_9_2_1_13824_1_5120(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 2U, 1U, 13824, 1U, 5120U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_3_1_13824_1_5120(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 3U, 1U, 13824, 1U, 5120U>(out, compressed, x, codebook);
}
...
__host__ extern void decompress_matvec_16_9_4_1_13824_1_5120(
    ...
    decompress_matvec<16U, 9U, 4U, 1U, 13824, 1U, 5120U>(out, compressed, x, codebook);
}
